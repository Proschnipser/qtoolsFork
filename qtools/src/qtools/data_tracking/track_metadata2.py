...
class metadata():  
    ...
    collected_keys = [
        ...
        'model_type', 'sigma', 'vec_type', 'mutation_scheme', 
        'vec_len', 'vector_file', 'out_dir', 'output_dims']
        

    collected_automatic = ['epochs', 'learning_rate', 'batch_size',  
        'sigma', 'vec_len', 'vector_file', 'out_dir', 'mutation_scheme',
        'output_dims']
    ...
    def record(cls, local_input):
        ...
        This function assumes you have defined local variables: 
            ...
            mutation_scheme : str 
                indicator on which simulated vector was used for training           
        ...
        # update vec_type with known mutation schemes
        if 'mutation_scheme' in collected.keys(): 
            if collected['mutation_scheme'] == 'n350': collected['vec_type'] = 'rRNA'
            elif collected['mutation_scheme'] == 's8_n20m3_r7': collected['vec_type'] = 'simulated'
            else:
                collected['mutation_scheme'] = collected['vec_type']  = 'nan'
        else: 
            collected['mutation_scheme'] = collected['vec_type']  = 'nan'
...
class mutationscheme():
    ...
    def __init__(self, infos):
        ...
        self.veclength = self.__get_veclength()
...
def get_metadata(path):    
    ...
    meta['trainvec'] = [x[-2] for x in meta['vector_file'].str.split('/')]
    return meta 
